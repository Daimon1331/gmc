...
//    wp_enqueue_script( 'popper', 'https://unpkg.com/@popperjs/core@2');
    ...
    wp_enqueue_script( 'style_swiper_js', get_template_directory_uri() . '/assets/js/swiper-bundle.js');
    wp_enqueue_style( 'style_bswiper_css', get_template_directory_uri() . '/assets/css/swiper-bundle.css');
    ...
    wp_enqueue_script( 'style_gmc_js', get_template_directory_uri() . '/assets/js/gmc.js');
